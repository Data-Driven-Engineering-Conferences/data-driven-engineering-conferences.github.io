...
const GITHUB_URL = 'https://github.com/Data-Driven-Engineering-Conferences/data-driven-engineering-conferences-iise2026-codebase';
const DATAVERSE_URL = 'https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/8NYZTI';
